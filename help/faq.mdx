...
<AccordionGroup>
  ...
  <Accordion title="Are guardrails generated per repo?">
    ...
    See [Repo guardrails](/guardrails/repo-guardrails) for how scoping works in monorepos and multi-repo workspaces.
  </Accordion>
  ...
  <Accordion title="How is this different from manually writing rules.md?">
    ...
    - It goes stale as the codebase changes. Sparkle regenerates rules from the current code.
