...
Both paths connect to the same Sparkle workspace and apply the same guardrails. The CLI bundles the extension setup, so most developers only need one install.
