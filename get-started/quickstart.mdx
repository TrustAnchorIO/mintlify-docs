...
<CardGroup cols={3}>
  <Card title="Cursor" icon="/images/icons/cursor.svg" href="/extension/cursor">
    Install Sparkle Guardrails extension in Cursor.
  </Card>

  <Card title="Windsurf" icon="/images/icons/windsurf.svg" href="/extension/windsurf">
    Install Sparkle Guardrails extension in Windsurf.
  </Card>

  <Card title="VS Code" icon="/images/icons/visualstudiocode.svg" href="/extension/vscode">
  ...
  <Card title="Claude Code" icon="/images/icons/claude.svg" href="/cli/claude-code">
    Configure Claude Code with the Sparkle CLI.
  </Card>

  <Card title="Codex" icon="/images/icons/openai.svg" href="/cli/codex">
